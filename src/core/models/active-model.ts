 ...
 *
 * Used for per-job (trigger/cron) model overrides: at create-time to reject a
 * bad id with a clear error, and at fire-time to fall back gracefully if the
 * catalog changed after the job was created.
 */
